#!/usr/bin/ruby
#
#	Ruby-WordNet Distribution Maker Script
#	$Id: makedist.rb,v 1.1 2003/08/06 08:01:12 deveiant Exp $
#
...
Rcsid = %q$Id: makedist.rb,v 1.1 2003/08/06 08:01:12 deveiant Exp $
...
def main
	...
	opts.each do |opt, arg|
		...
		when '--verbose'
			...
			errorMessage( "No such option '#{opt}'" )
		end
